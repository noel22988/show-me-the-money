...
function Onboarding({onComplete}){
  ...
  const steps=[
    <div key="s0">
      ...
      <p style={{margin:"0 0 24px",fontSize:14,color:T.textSecondary,lineHeight:1.6}}>Your personal finance tracker. Setup takes about a minute.</p>
        ...
        <div style={{maxWidth:560,margin:"0 auto"}}>
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:16}}>
            <div style={{display:"flex",alignItems:"center",gap:10}}>
              ...
              <div>
                <div style={{fontSize:13,fontWeight:600,color:T.textPrimary}}>{profile.name||"My Finance"}</div>
