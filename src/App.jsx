      ...
      {data.map(({m,inc,fixed,variable,saved,hasIncome})=>{
        ...
        return <div key={m} style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",gap:3}}>
          <div style={{width:"100%",display:"flex",gap:3,alignItems:"flex-end",height:barH-14}}>
            ...
            <div style={{flex:1,display:"flex",flexDirection:"column",justifyContent:"flex-end",height:barH-14,gap:0}}>
              {saved>0&&<div style={{borderRadius:savH>0&&fixH===0&&varH===0?"4px 4px 0 0":"0",background:T.positive,height:savH,transition:"height .5s ease",flexShrink:0}}/>}
              {variable>0&&<div style={{borderRadius:fixH===0?"4px 4px 0 0":"0",background:T.negative,height:varH,transition:"height .5s ease",flexShrink:0}}/>}
              {fixed>0&&<div style={{borderRadius:"4px 4px 0 0",background:T.info,height:fixH,transition:"height .5s ease",flexShrink:0}}/>}
            </div>
          </div>
